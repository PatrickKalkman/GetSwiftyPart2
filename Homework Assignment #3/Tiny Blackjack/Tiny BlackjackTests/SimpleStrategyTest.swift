...
//    Bank 7 t/m A: je past bij 17 punten of hoger
    ...
    func test_stand_when_dealer_7_to_11_hand_is_17_or_higher() {
        let card1: Card = Card(Suit.heart, Rank.eight, 1)
        let card2: Card = Card(Suit.club, Rank.nine, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)

        let card3: Card = Card(Suit.club, Rank.ten, 1)
        let dealerHand: Hand = Hand()
    ...
    func test_stand_when_dealer_2_to_6_hand_is_18_or_higher_including_ace() {
        ...
        let card2: Card = Card(Suit.club, Rank.seven, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)
    ...
    func test_stand_when_dealer_7_to_11_hand_is_19_or_higher_including_ace() {
        let card1: Card = Card(Suit.heart, Rank.ace, 1)
        let card2: Card = Card(Suit.club, Rank.eight, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)
...
//    2-2, 3-3, 6-6, 7-7, 9-9: alleen splitsen als de bank 2 t/m 6 heeft
    ...
    func test_split_when_ace_ace() {
        let card1: Card = Card(Suit.heart, Rank.ace, 1)
        let card2: Card = Card(Suit.club, Rank.ace, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)
...
//    2-2, 3-3, 6-6, 7-7, 9-9: alleen splitsen als de bank 2 t/m 6 heeft
    func test_split_when_two_two_dealer_lower_than_7() {
        let card1: Card = Card(Suit.heart, Rank.two, 1)
        let card2: Card = Card(Suit.club, Rank.two, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)

        let card3: Card = Card(Suit.club, Rank.two, 1)
        let dealerHand: Hand = Hand()
        dealerHand.add(card3)
    ...
    func test_stand_when_value_20() {
        let card1: Card = Card(Suit.heart, Rank.king, 1)
        let card2: Card = Card(Suit.club, Rank.queen, 1)
        let playerHand: Hand = Hand()
        playerHand.add(card1)
        playerHand.add(card2)
        
        let card3: Card = Card(Suit.diamond, Rank.king, 1)
        let dealerHand: Hand = Hand()
        dealerHand.add(card3)
        
        let card4: Card = Card(Suit.diamond, Rank.five, 1)
        card4.faceUp = false
