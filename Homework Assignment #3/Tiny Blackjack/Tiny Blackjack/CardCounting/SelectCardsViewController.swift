...
class SelectCardsViewController: BlackjackViewControllerBase, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func showMaximumSelection() {
        let banner = NotificationBanner(title: "Maximum number of cards selected (\(maximumNumberOfCardsToSelect))",
            subtitle: "Deselect a card before selecting another one", style: BannerStyle.info)
